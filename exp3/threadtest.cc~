...
void TestValueOne()
{
	...
	//1. fill your code here.
        Thread *t1 = new Thread("Inc_v1_0");
        Thread *t2 = new Thread("Inc_v1_1");
        Thread *t3 = new Thread("Dec_v1_0");
        Thread *t4 = new Thread("Dec_v1_1");
...
void TestValueMinusOne()
{
	...
	printf("enter TestValueMinusOne, value=%d...\n", value);
        ...
        Thread *t1 = new Thread("Inc_v2_0");
        Thread *t2 = new Thread("Inc_v2_1");
        Thread *t3 = new Thread("Dec_v2_0");
        Thread *t4 = new Thread("Dec_v2_1");
